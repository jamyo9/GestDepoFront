System.register(['@angular/core', '@angular/forms', '@angular/router', '../../shared/validators/basicValidators', '../services/user.service', '../../objects/user.object'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, forms_1, router_1, basicValidators_1, user_service_1, user_object_1;
        ...
        execute: function() {
            UserFormComponent = (function () {
                ...
                UserFormComponent = __decorate([
                    core_1.Component({
                        templateUrl: 'app/users/components/html/user-form.component.html'
                    }), 
