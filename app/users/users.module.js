System.register(['@angular/core', '@angular/common', '@angular/forms', '@angular/router', '@angular/http', './components/user-form.component', './components/users.component', './services/user.service', '../prevent-unsaved-changes-guard.service'], function(exports_1, context_1) {
    "use strict";
