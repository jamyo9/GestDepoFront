...
DrawingBoard.Board.prototype = {
	...
	goBackInHistory: function() {
		//console.log("this.restoreHistory:" + this.restoreHistory);
	...
	getImgFromHidden: function() {
		//console.log($("#designHidden").val());
		return $("#designHidden").val();
	},

	downloadImg: function() {
		$("#designHidden").val(JSON.stringify(this.getImg()));
		/*
		var img = this.getImg();
